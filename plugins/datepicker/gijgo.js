...
gj.picker.methods = {
    ...
    initialize: function($input, data, methods) {
        ...
        if (data.uiLibrary === 'bootstrap') {
            ...
            $rightIcon = $('<div class="input-group-append"><span class="input-group-text">' + data.icons.rightIcon + '</span></div>');
        } else {
...
gj.grid.methods = {
    ...
    getById: function($grid, id) {
        var result = null,
            i, primaryKey = $grid.data('primaryKey'),
...
gj.datepicker.config = {
    base: {
        ...
        icons: {
            ...
            previousMonth: '<i class="las la-angle-left"></i>',
            nextMonth: '<i class="las la-angle-right"></i>'
        },
